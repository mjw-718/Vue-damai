...
export default {
    ...
    methods: {
    addtocart(){
        // console.log("detail",this.listone)
      this.$store.dispatch("cart/addtocart",this.listone)
